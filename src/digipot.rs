...
use crate::{spi::{PayloadSPI, Polarity::IdleLow, Phase::CaptureOnFirstEdge}, pcb_mapping::pin_name_types::DigipotCSPin};
...
impl Digipot {
    ...
    pub fn set_channel_to_resistance(&mut self, channel: DigipotChannel, wanted_resistance: u32, spi_bus: &mut impl PayloadSPI<{IdleLow}, {CaptureOnFirstEdge}>){
